...
class ScriptHandler {
  ...
  public static function createRequiredFiles(Event $event) {
    ...
    if (!$fs->exists($drupalRoot . '/sites/default/settings.php') && $fs->exists($drupalRoot . '/sites/default/default.settings.php')) {
      ...
      $event->getIO()->write("Create a sites/default/settings.php and sites/default/settings.local.php file with chmod 0666");
      $event->getIO()->write("Make sure you move the database configuration from sites/default/settings.php to sites/default/settings.local.php");
